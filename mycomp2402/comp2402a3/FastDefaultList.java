...
public class FastDefaultList<T> extends AbstractList<T> {
	...
	public T get(int i) {
		...
		// Infinity, no need to check >n+1
		if (i < 0) throw new IndexOutOfBoundsException();
        // Hint: Are you sure findPred(i).next is the node you're looking for?
		// check null,if i is correct 
		Pair pair = findPred(i);
		if (pair.u.next[0] != null && pair.i + pair.u.length[0] == i) {
	...
	public static void main(String[] args) {
		  FastDefaultList<String> l = new FastDefaultList<String>();

	    System.out.println(l.set(100, "hello"));	
	    
	    System.out.println(l.get(100));//hello
	    System.out.println(l.set(50, "hi"));	
	    System.out.println(l.get(100));	//hello
